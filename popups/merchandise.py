...
class MerchandisePopup(wxDialog):
...
#        self.SetBackgroundColour("FIREBRICK")
        ...
        self.static1=wxStaticText(self, -1, "Item Description:",pos=wxPoint(15,15))
        self.description=wxTextCtrl(id=-1,name="merchandise_description", parent=self, pos=wxPoint(15,40), size=wxSize(200,25), style=0)

        self.static2=wxStaticText(self, -1, "Item Price:",pos=wxPoint(15,70))
        self.price=wxTextCtrl(id=-1,name="merchandise_price", parent=self, pos=wxPoint(15,110), size=wxSize(200,25), style=0)
