...
__CHEETAH_genTime__ = 1309384747.5424321
__CHEETAH_genTimestamp__ = 'Wed Jun 29 17:59:07 2011'
__CHEETAH_src__ = 'ReportListTemplate.html'
__CHEETAH_srcLastModified__ = 'Sun Apr 18 18:17:01 2010'
...
class ReportListTemplate(Skeleton):
...
''')
    ...
    _mainCheetahMethod_for_ReportListTemplate= 'writeBody'

## END CLASS DEFINITION

if not hasattr(ReportListTemplate, '_initCheetahAttributes'):
    templateAPIClass = getattr(ReportListTemplate, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(ReportListTemplate)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=ReportListTemplate()).run()
