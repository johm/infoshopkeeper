...
__CHEETAH_genTime__ = 1309384747.533654
__CHEETAH_genTimestamp__ = 'Wed Jun 29 17:59:07 2011'
__CHEETAH_src__ = 'KindListTemplate.html'
__CHEETAH_srcLastModified__ = 'Sun Apr 18 18:17:00 2010'
...
class KindListTemplate(Skeleton):
...
''')
    ...
    _mainCheetahMethod_for_KindListTemplate= 'writeBody'

## END CLASS DEFINITION

if not hasattr(KindListTemplate, '_initCheetahAttributes'):
    templateAPIClass = getattr(KindListTemplate, '_CHEETAH_templateClass', Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(KindListTemplate)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=KindListTemplate()).run()
