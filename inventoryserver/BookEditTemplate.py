...
__CHEETAH_genTime__ = 1309384747.4809761
__CHEETAH_genTimestamp__ = 'Wed Jun 29 17:59:07 2011'
__CHEETAH_src__ = 'BookEditTemplate.html'
__CHEETAH_srcLastModified__ = 'Sun Apr 18 18:16:46 2010'
...
class BookEditTemplate(Skeleton):
    ...
    def pagetitle(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${book.title.booktitle}')) # from line 5, col 19.
        write('''
''')
    ...
    def body(self, **KWS):
        ...
        write('''<h1>''')
        _v = VFFSL(SL,"book.title.booktitle",True) # '$book.title.booktitle' on line 9, col 5
        if _v is not None: write(_filter(_v, rawExpr='$book.title.booktitle')) # from line 9, col 5.
        write('''</h1>
<form method="get" action="/bookedit">
''')
        _v = VFFSL(SL,"book.object_to_form",True) # '$book.object_to_form' on line 11, col 1
        if _v is not None: write(_filter(_v, rawExpr='$book.object_to_form')) # from line 11, col 1.
        write('''
</form>
''')
